<?php
/*
 * Travel Logic - ticket service classes.
 */

/**
 * Destination (auto suggest) request
 */
class Travel_Logic_Ticket_Auto_Suggest extends Travel_Logic_Request
{
	/**
	 */
 ...
 */
class Travel_Logic_Ticket_Search extends Travel_Logic_Request
{
	/**
	 */
	public function request( $args )
...
/**
 * Ticket/GetTicketDetails request
 */
class Travel_Logic_Ticket_Details extends Travel_Logic_Request
{
	...
	public function request( $args )
	{
		...
		$this
			->method('POST')
			->fields( $args )
			->fetch_json( 'Ticket/GetTicketDetails');
...
/**
 * Ticket/GetTicketValuation request
 */
class Travel_Logic_Ticket_Valuation extends Travel_Logic_Request
{
	/**
	 */
	public function request( $args )
	{
        ...
        $this
            ->method( 'POST' )
            ->fields( $args )
            ->fetch_json( 'Ticket/GetTicketValuation' );
...
/**
 * Ticket/BookTicket request
 */
class Travel_Logic_Ticket_Book_Ticket extends Travel_Logic_Request
{
	/**
	 */
	public function request( $args )
...
/**
 * Ticket/GetCancellationPolicy request
 */
class Travel_Logic_Ticket_Confirm_Booking extends Travel_Logic_Request
{
	/**
	 */
	public function request( $args )
	{
		...
		$this
			->method( 'POST' )
			->fields( $args )
			->fetch_json( 'Ticket/ConfirmBooking' );
...
class Travel_Logic_Tickets_Template
{
	/**
