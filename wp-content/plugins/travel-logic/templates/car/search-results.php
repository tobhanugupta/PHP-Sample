<?php
/**
 * Travel Logic - car search results template
 */
?>
...
<div ng-app="travelLogicApp">
		 ...
		 <div class="container-fluid">
			 <div class="span12 has-transparency">
			 	<ul class="breadcrumbs">
				  <li class="is-home"></li>
				  <li><a href="#">Cars and Excursions for {{fields.destination}} Area</a></li>
				</ul>
		...
		<div class="container-fluid" style="background: #fff">
		 	<div class="span12 same-height">
		 		...
		 		<div class="row-fluid">
		 			<div class="span3">
		 				<div class="sidebar">
							<div class="cars-starting-at">
								<span>
									<strong>{{filteredCars.length}}</strong>
									<ng-pluralize count="filteredCars.length"
												when="{
													'one': 'Car starting at',
													'other': 'Cars starting at'

												}">
									</ng-pluralize>
								</span>
								<br />
								<!-- <span class="price">${{minPriceCar.MinAverPrice}}</span><br /> -->
								...
								<form action="<?php tlogic_the_car_search_action() ?>" method="GET">
									...
									<div class="content-box">
										...
										<?php endif; ?>
											...
											<input name="destination" type="text" placeholder="Destination" class="span12" autocomplete="off" value="<?php tlogic_the_car_search_field_value( 'destination' ) ?>">
											</label>
											<?php tlogic_the_car_search_field_error( 'destination' ); ?>
											...
											<div class="form-inline">
												<div class="control-group span6 <?php tlogic_the_car_search_ctrlgrp_class( 'checkin' ) ?>">
													<label class="control-label">Check In:
														...
														<div class="input-append">
															<input id="dpd1" name="checkin" type="text" class="span9" value="<?php tlogic_the_car_search_field_value( 'checkin' ); ?>">
												...
												<div class="control-group span6 <?php tlogic_the_car_search_ctrlgrp_class( 'checkout' ) ?>">
													<label class="control-label">Check Out:
														...
														<div class="input-append">
															<input id="dpd2" name="checkout" type="text" class="span9" value="<?php tlogic_the_car_search_field_value( 'checkout' ); ?>">
															<span class="add-on"><i class="icon-calendar"> </i></span>
														</div>
													</label>
											...
											<div class="row-fluid" id="carRoomDetail_1">
												<div class="span4">
													<label>Room(s)
												...
												<div class="span4 children-box">
													<label>Children
														...
														<!-- <select name="num_child_1" class="num_child" data-child="1" class="span12">
															<?php tlogic_the_car_search_num_child_options(); ?>
														</select>
														<?php tlogic_the_car_search_field_error( 'num_child' ); ?> -->
													</label>
												</div>
											</div>
											...
											<div id="receiveCarDeails">
												<?php
													...
													for($x = 2; $x <= $_GET['num_room']; $x++) {
														echo '<div class="row-fluid" id="carRoomDetail_'. $x .'" style="padding: 10px 0; border-top: 1px solid #fa6044;">'.
																'<div class="span4">'.
																'<br />Room '. $x .
																'</div>'.
																'<div class="span4 adult-box">'.
		 			...
		 			<div class="span9">
		 				<div class="results-content">
		 					<div class="row-fluid">
		 						...
		 						<div class="span6">
		 							<ul class="inline-list sort-by">
		 								<li class="span4"><a href ng-click="sortField='Name';sortReverse=!sortReverse" id="orderByCarName" data-sort="<?php if ($_GET['orderByCarName'] == "DESC") { echo "ASC"; } else { echo "DESC"; } ?>"><img src="<?php echo get_template_directory_uri(); ?>/images/car-name.jpg"></a></li>
		 								<!-- <li class="span4"><a href ng-click="sortField='MinAverPrice';sortReverse=!sortReverse" id="orderByCarPrice" data-sort="<?php if ($_GET['orderByCarPrice'] == "DESC") { echo "ASC"; } else { echo "DESC"; } ?>"><img src="<?php echo get_template_directory_uri(); ?>/images/price.jpg"></a></li> -->
			 				...
			 				<div class="row-fluid animate"
			 						ng-if="cars.length"
			 						dir-paginate="car in filteredCars = (cars | filter:filterCars) | orderBy:sortField:sortReverse | itemsPerPage: carsPerPage"
							    ...
							    <div class="span12">
							        <div class="results">
							            <div class="inner">
							            	 <div class="row-fluid">
							            	 	<div class="span2">
							            	 		<a href="{{config.details_page}}{{car.CarId}}"><img class="pull-left" ng-src="{{car.CarInfo.ImageList[1].Url}}"></a>
							            	 	</div>
							            	 	<div class="span10">
							            	 		<div class="car-descriptions">
							 				             <p class="car-name">
							 					            <a ng-href="{{config.details_page}}{{car.CarId}}"><strong>{{car.CarInfo.Name}}</strong></a>
							 				             </p>
                                                        <strong>{{car.CarInfo.Classification.Value}}</strong>
							 				             <p class="car-description">{{car.CarInfo.DescriptionList[0].Value}}</p>
							 		                    <br />
							 			             </div>
							            	 	</div>
							            	 </div>
                                             <div class="row-fluid">
                                                <table class="span10 offset1 table table-striped table-hover">
                                                    ...
                                                    <tbody>
                                                        <tr ng-repeat="modality in car.AvailableModality">
                                                            <td>{{modality.Name}}</td>
                                                            <td>
                                                                <!-- <p ng-repeat="price in modality.PriceList">
                                                                    <strong ng-show="price.Amount > 0">{{price.Description}}: {{price.Amount}} {{car.Currency.Code}}</strong>
                                                                </p> -->

                                                                <p><strong>{{modality.PriceList[0].Description}}: {{modality.PriceList[0].Amount | currency : '' }} {{car.Currency.Code}}</strong></p>
                                                                <p><strong>{{modality.PriceList[1].Description}}: {{modality.PriceList[1].Amount | currency : '' }} {{car.Currency.Code}}</strong></p>
                                                                <p ng-show="modality.PriceList[2].Amount"><strong>{{modality.PriceList[2].Description}}: {{modality.PriceList[2].Amount | currency : '' }} {{car.Currency.Code}}</strong></p>
                                                            </td>
                                                            <td>
                                                                <select
                                                            ...
                                                            <td>
                                                                {{ modality.PriceList[3].Amount | currency : '' }} {{car.Currency.Code}}
                                                            </td> <!-- Need to create the function to calculate based on number of childs and date -->
                                                            <td>
                                                                <a role="button" class="btn btn-danger" ng-click="book(car, modality)">Book</a>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
	...
	<div id="myModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	  <div class="modal-header">
	    ...
	    <h3 id="myModalLabel">Car Results</h3>
	  </div>
