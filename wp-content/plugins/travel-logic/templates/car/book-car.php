		...
		<div class="span6">
			...
			<div class="well">
                ...
                <?php if ( tlogic_has_cars() ): ?>
                    <?php while ( tlogic_cars() ): tlogic_the_ticket(); ?>
                        <p><strong><?php tlogic_the_ticket_name(); ?></strong></p>
                        <p>From: <?php tlogic_the_ticket_confirmation_date_from(); ?></p>
                        <p>To: <?php tlogic_the_ticket_confirmation_date_to(); ?></p>

                        <h5 class="span10">Car Total</h5>
                        <h5 class="span1">$<?php tlogic_the_ticket_confirmation_total(); ?></h5>
                    <?php endwhile; ?>
                <?php endif; ?>
            ...
            <div class="well">
                <?php foreach ( tlogic_get_ticket_confirmation_all_comments() as $comment ): ?>
