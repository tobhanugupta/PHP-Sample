<?php
/**
 * Travel Logic - ticket rooms template
 */
?>

<?php tlogic_the_ticket_rooms(); ?>
<h3>Room type</h3>

<?php while ( tlogic_the_ticket_room_type() ): ?>
   <hr class="separator-sidebar" />

	<div class="row-fluid results">
   		<div class="span4 incomplete"></div>
		<div class="span5">
			<h4><?php tlogic_the_ticket_room_type_name() ?></h4>
			...
			<?php foreach( tlogic_get_the_ticket_amenities() as $Amenity ): ?>
			   <li><?php echo $Amenity->Name; ?></li>
			<?php endforeach; ?>

			<ul class="room-details-list incomplete">
				<li>FREE Cancellation</li>
				<li>Pay at ticket or pay today</li>
			</ul>
		</div>
   		<div class="span3">
   			<div class="prices">
	   			<span class="price"><?php tlogic_the_ticket_rooms_currency(); ?> <?php tlogic_the_ticket_room_type_avg_price(); ?></span>
	            <span class="avg">avg/night</span>
				<br /><br />
	   			<a href="<?php tlogic_the_ticket_room_to_book_permalink( tlogic_get_the_ticket_room_type_id() ) ?>" class="btn-select"><?php _e( 'Book', 'travel-logic'); ?></a>
	   		</div>
   		</div>
	</div>
	<!--<a href="#" data-tlogic-room-type-id="<?php tlogic_the_ticket_room_type_id() ?>" class="tlogic-cancel-policy"><?php _e( 'View cancellation policy', 'travel-logic' ) ?></a>-->
<?php endwhile; ?>
			...
			function(e) {
				$.post(
					'<?php echo admin_url( 'admin-ajax.php' ); ?>',
					{
						...
						ticket_id: '<?php tlogic_the_ticket_id() ?>',
