...
{ 
    ...
    wp_register_style( 'wp-bootstrap-datepicker', get_template_directory_uri() . '/library/css/datepicker.css', array(), '1.0', 'all' );
    wp_register_style( 'flexslider', get_template_directory_uri() . '/library/css/flexslider.css', array(), '1.0', 'all' );
    wp_register_style( 'ion.rangeSlider', get_template_directory_uri() . '/library/css/ion.rangeSlider.css', array(), '1.0', 'all' );

    wp_register_style( 'custom', get_template_directory_uri() . '/custom.css', array(), '1.1', 'all' );

    
    wp_enqueue_style( 'bootstrap' );
    wp_enqueue_style( 'bootstrap-responsive' );
    wp_enqueue_style( 'wp-bootstrap');
    wp_enqueue_style( 'wp-bootstrap-datepicker');
...
function theme_js(){
  ...
  wp_register_script('bootstrap-datepicker', get_template_directory_uri().'/library/js/bootstrap-datepicker.js');
  ...
  wp_register_script('gmaps', 'https://maps.googleapis.com/maps/api/js?v=3.exp');
  ...
  wp_register_script('flexslider-js', get_template_directory_uri().'/library/js/jquery.flexslider.js');

  wp_register_script('ion.rangeSlider', get_template_directory_uri().'/library/js/ion.rangeSlider.min.js');

  // wp_enqueue_script('less', array(''), '1.3.0', true);
  wp_enqueue_script('jquery');
  wp_enqueue_script('bootstrap', array('jQuery'), '1.1', true);
  wp_enqueue_script('bootstrap-datepicker', array('jQuery'), '1.1', true);
  ...
  wp_enqueue_script('gmaps', '', '1.1', true);
  wp_enqueue_script('wpbs-scripts', array('jQuery'), '1.1', true);
  wp_enqueue_script('modernizr', array('jQuery'), '1.1', true);
  wp_enqueue_script('flexslider-js', array('jQuery'), '1.1', true);
  wp_enqueue_script('ion.rangeSlider', array('jQuery'), '1.1', true);
}
