...
<!--[if (gte IE 9)|(gt IEMobile 7)|!(IEMobile)|!(IE)]><!--><html <?php language_attributes(); ?> class="no-js"><!--<![endif]-->
	...
	<body <?php body_class(); ?> <?php if (tlogic_frontend_is_hotel_search() === true) { ?>style="background-color: #e7e4e4"<?php } ?>>
			...
			<div id="inner-header" class="clearfix">
                ...
                <div class="row-fluid">
                	...
                	<div class="span3">
                		...
                		<h1 class="no-margin">
                			<a class="brand" id="logo" title="<?php echo get_bloginfo('description'); ?>" href="<?php echo home_url(); ?>"><img src="<?php echo get_template_directory_uri(); ?>/images/logo-varanda.jpg"></a>
                		</h1>
					...
					<div class="span2">
						<span class="phone">1.800.451.5212</span>
					</div>
                </div><!-- end .row -->
